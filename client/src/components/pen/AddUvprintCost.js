...
const uvValidator = require("../../validators/Pen/uvPrintValidator");

function Transition(props) {
    return <Slide direction="down" {...props} />;
}
class AddUvPrint extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            product: "",
    ...
    handleAdd = () => {
        ...
        let { errors, isValid } = uvValidator.uvPrintInput(data);
    ...
    componentDidMount() {
        this.setState({
            product: this.props.uvPrint.product,
            costs: this.props.uvPrint.costs
        }, () => {
            ...
            <div style={{ width: "50%" }}>
                ...
                >
                    <DialogTitle id="alert-dialog-slide-title">
                        {this.props.action + " UV Print Cost"}
                    </DialogTitle>
                    <FormHelperText
...
AddUvPrint.propTypes = {
    //classes: PropTypes.object.isRequired
    open: PropTypes.bool.isRequired
};

export default AddUvPrint;
