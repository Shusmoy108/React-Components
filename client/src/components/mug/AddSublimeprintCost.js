...
const sublimeValidator = require("../../validators/Mug/sublimationPrintValidator");

function Transition(props) {
    return <Slide direction="down" {...props} />;
}
class AddSublimationPrint extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            product: "",
    ...
    handleAdd = () => {
        ...
        let { errors, isValid } = sublimeValidator.sublimationPrintInput(data);

        if (!isValid) {
            this.setState({ errors: errors });
        } else {
            this.setState({ errors: {} });
            this.props.add(product, costs);
        }
    };
    ...
    componentDidMount() {
        this.setState({
            product: this.props.sublimePrint.product,
            costs: this.props.sublimePrint.costs
        }, () => {
            ...
            <div style={{ width: "50%" }}>
                ...
                >
                    <DialogTitle id="alert-dialog-slide-title">
                        {this.props.action + " Sublimation Print Cost"}
                    </DialogTitle>
                    <FormHelperText
...
AddSublimationPrint.propTypes = {
    //classes: PropTypes.object.isRequired
    open: PropTypes.bool.isRequired
};

export default AddSublimationPrint;
